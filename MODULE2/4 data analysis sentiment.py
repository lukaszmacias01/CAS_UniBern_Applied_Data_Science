...
df = pd.read_excel('TSLA_sentiment_1m.xlsx')
...
sns.violinplot(data=df[[ 'final_sentiment_vader']], color='orange')

plt.title('Violin Plot of Final Sentiment', fontsize=16, color='black')
plt.ylabel('Sentiment Score', fontsize=14)
