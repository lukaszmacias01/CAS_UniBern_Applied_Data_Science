...
tsla = pd.read_csv('tsla_comments_1000000.csv')
...
# demo 
sentiment = sia.polarity_scores("Cathie says …her bullish Tesla stock price target is “$3,100” a share. That’s a 13X from current price levels.")
print(sentiment) 
...
tsla.to_excel('TSLA_sentiment_1m.xlsx')
